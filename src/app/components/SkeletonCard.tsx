    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="bg-white dark:bg-gray-900 rounded-xl border border-white dark:border-gray-900 p-4"
          >
            <div className="flex items-center gap-3 mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {[1, 2].map((i) => (
          <div
            key={i}
            className="bg-white dark:bg-gray-900 rounded-xl border border-white dark:border-gray-900 p-6"
          >
